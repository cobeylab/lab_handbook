...
```{r private-nodes, out.width='100%', echo=FALSE, fig.show='hold', fig.align="center", fig.cap='Node list with status September 2024'}
knitr::include_graphics(rep("images/private-nodes-Sept2024.png"))
```
