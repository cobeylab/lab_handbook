...
* For grants and papers, the central challenge is to articulate an interesting question and show how you have helped or will help answer it. Practice doing this from the beginning of your research project, as you sketch ideas and results in your notebook. A key skill, and the reason it's important to read, talk with others, attend seminars, etc., is that what's considered an interesting question varies widely by field. Learn to appeal to different audiences.
...
13. Draft the cover letter, or whatever introductory text the journal requires. The cover letter should very succinctly describe what is important about the manuscript and place it very directly in context of other work ("To our knowledge, this is the first paper that...") without repeating the abstract. 
14. When all coauthors have approved the manuscript, we submit it to a preprint server (without journal-specific typesetting), publish the repository, and submit to a journal. If the work is funded by CIVIC or CEIRR, we also need to inform them of the preprint.
15. Ask Jessie to add the preprint as a "Paper" to the lab website. Prepare a one-sentence, lay-person summary of the main finding for us to add as a news item on the side. Draft a "Tweetorial" for BlueSky or post for LinkedIn. If the work is CEIRR-funded, it should probably also be added to the Computational Modeling Core website.
16. Celebrate!
...
1. You'll almost certainly have funding from me, but it's still usually a good idea search for opportunities. Check with me first. Ask the grad student and postdoc coordinators, ask your peers, do searches, etc. 
...
* Say you'd include the research statement/proposal synopsis/relevant material by X date, where X is ideally at least three weeks before the deadline, and ask them if they need any material sooner.
* In the follow-up email or potentially the initial one, give the writer a suggested list of points to highlight in their letter. This is your opportunity to ask them to emphasize aspects of your training or goals that are particularly valuable or nuanced, e.g., you made the key insight for a research project, the proposed research is especially novel, you were delayed in publishing because of a health problem but are otherwise fast, etc.
* Thank them for writing, and follow up with the writer when you learn the outcome of the competition, thanking them again for their support.
...
* CEIRR and CIVIC are contracts that generally do not support conference participation: all travel must be in direct service of the research. They often can be used for trips to visit collaborators in the consortium. *All travel for CEIRR and CIVIC must be approved in writing by the center at least a month before the travel occurs.* Please talk with Jessie and me well in advance if you are CEIRR/CIVIC funded and want to travel. 
* We need to book travel through the Fox Travel Agency through a University portal. Jessie can book the flight and hotel for you so you do not have to pay and then be reimbursed. If you pay upfront yourself (this is generally frowned on), you will have to wait until after the travel is complete to be reimbursed.
...
* Submit receipts to Jessie within three weeks of travel. 
