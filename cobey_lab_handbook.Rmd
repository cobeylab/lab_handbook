...
```{r danse-macabre, out.width='50%', echo=FALSE, fig.show='hold', fig.cap='A contrasting time scale of research'}
...
* **Be clear.** Use topic sentences. Assume your reader is an intelligent first-year graduate student, but maybe with less time on her hands. Try to state things vividly and directly. Your writing will almost always improve if you try to explain your reasoning as transparently as possible.
...
From this principle, it follows we should not discriminate or draw conclusions about scientific and professional merit based on a huge class of dumb things, like whether someone wears or doesn't wear makeup, seems really excited about sports, programmed in Fortran at age 3, knows your friends, drinks socially, etc.
We should also make an effort to work well with people who are different from us.
